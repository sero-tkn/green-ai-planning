(define (domain barman)
  ...
  (:action grasp
             ...
             :precondition (and (ontable ?c) (or (handempty ?h) (DUMMY-FLAG)))
  ...
  (:action leave
             :parameters (?h - hand ?c - container)
             :precondition (or (holding ?h ?c) (DUMMY-FLAG))
  ...
  (:action empty-shaker
           ...
           :precondition (and (holding ?h ?s)
			      ...
			      (shaked ?s)
			      (shaker-level ?s ?l)
			      (or (shaker-empty-level ?s ?l1) (DUMMY-FLAG)))
