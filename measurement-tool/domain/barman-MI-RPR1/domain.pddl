(define (domain barman)
  ...
  (:action grasp
             ...
             :precondition (and (ontable ?c) (handempty ?h) (ontable ?c))
  ...
  (:action leave
             :parameters (?h - hand ?c - container)
             :precondition (and (holding ?h ?c) (holding ?h ?c))
  ...
  (:action empty-shaker
           ...
           :precondition (and (holding ?h ?s)
			      ...
			      (shaked ?s)
			      (shaker-level ?s ?l)
			      (shaker-empty-level ?s ?l1) (holding ?h ?s))
