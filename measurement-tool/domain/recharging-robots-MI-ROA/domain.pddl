...
(:action move
    :parameters (?dummy - robot ?r - robot ?from - location ?to - location
...
(:action recharge
    :parameters (?dummy - robot ?rfrom - robot ?rto - robot ?loc - location
...
(:action stop-and-guard
    :parameters (?dummy - robot ?r - robot ?l - location)
    :precondition
        (and
            (not (stopped ?r))
            (at ?r ?l)
...
(:action verify-guard-config
    :parameters (?dummy - config ?c - config)
    :precondition
        (and
            (forall (?l - location)
