...
(:init
    ...
    (BLOCKED cell-3-2 south)
    (BLOCKED cell-3-3 north)
    (BLOCKED cell-4-5 east)
    (BLOCKED cell-5-5 west)
    ...
    (BLOCKED cell-8-9 east)
    (BLOCKED cell-9-9 west)
    ...
    (at robot-1 cell-4-7) ;; red
    (at robot-2 cell-9-1) ;; blue
    (at robot-3 cell-8-2) ;; green
