...
(:init
    ...
    (BLOCKED cell-8-11 south)
    (BLOCKED cell-9-1 north)
    (BLOCKED cell-9-11 south)
    ...
    (BLOCKED cell-5-5 south)
    (BLOCKED cell-5-6 north)
    ...
    (BLOCKED cell-6-3 south)
    (BLOCKED cell-6-4 north)
    ...
    (BLOCKED cell-9-3 south)
    (BLOCKED cell-9-4 north)
    ...
    (BLOCKED cell-10-1 south)
    (BLOCKED cell-10-2 north)
    (BLOCKED cell-9-9 south)
    (BLOCKED cell-9-10 north)
    (BLOCKED cell-4-1 south)
    (BLOCKED cell-4-2 north)
    (BLOCKED cell-4-5 north)
    (BLOCKED cell-4-4 south)
    ...
    (BLOCKED cell-8-5 north)
    (BLOCKED cell-8-4 south)
    (BLOCKED cell-6-2 south)
    (BLOCKED cell-6-3 north)
    ...
    (BLOCKED cell-10-1 west)
    (BLOCKED cell-9-1 east)
    (BLOCKED cell-9-8 west)
    (BLOCKED cell-8-8 east)
    (BLOCKED cell-11-9 south)
    (BLOCKED cell-11-10 north)
    ...
    (at robot-1 cell-4-10) ;; red
    (at robot-2 cell-9-11) ;; blue
    (at robot-3 cell-11-8) ;; green
    (at robot-4 cell-5-5) ;; yellow
