...
(:init
    ...
    (BLOCKED cell-3-9 east)
    (BLOCKED cell-4-9 west)
    ...
    (BLOCKED cell-8-1 south)
    (BLOCKED cell-8-2 north)
    ...
    (BLOCKED cell-2-1 west)
    (BLOCKED cell-1-1 east)
    ...
    (at robot-1 cell-5-1) ;; red
    (at robot-2 cell-4-1) ;; blue
    (at robot-3 cell-3-5) ;; green
    (at robot-4 cell-6-8) ;; yellow
