...
(:init
    ...
    (BLOCKED cell-2-5 south)
    (BLOCKED cell-2-6 north)
    ...
    (BLOCKED cell-3-3 south)
    (BLOCKED cell-3-4 north)
    ...
    (at robot-1 cell-6-8) ;; red
    (at robot-2 cell-4-8) ;; blue
    (at robot-3 cell-8-4) ;; green
    (at robot-4 cell-1-2) ;; yellow
