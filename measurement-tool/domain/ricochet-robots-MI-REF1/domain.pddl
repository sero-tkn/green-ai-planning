...
(:action go
    ...
    :effect
        (and
            (not (nothing-is-moving)) (nothing-is-moving) (not (nothing-is-moving))
            (is-moving ?r ?dir)
...
(:action step
    ...
    :effect
        (and
            (not (at ?r ?cfrom)) (at ?r ?cfrom) (not (at ?r ?cfrom))
            (free ?cfrom)
            (not (free ?cto))
            (at ?r ?cto)
...
(:action stop-at-barrier
    ...
    :effect
        (and
            (not (is-moving ?r ?dir)) (is-moving ?r ?dir) (not (is-moving ?r ?dir))
            (nothing-is-moving)
