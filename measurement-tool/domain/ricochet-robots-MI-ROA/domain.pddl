...
(:action go
    :parameters (?dummy - robot ?r - robot ?dir - direction)
    :precondition
        (and
            (nothing-is-moving)
...
(:action step
    :parameters (?dummy - robot ?r - robot ?cfrom - cell ?cto - cell ?dir - direction)
    :precondition
        (and
            (is-moving ?r ?dir)
            (at ?r ?cfrom)
...
(:action stop-at-barrier
    :parameters (?dummy - robot ?r - robot ?cat - cell ?dir - direction)
    :precondition
        (and
            (is-moving ?r ?dir)
            (at ?r ?cat)
...
(:action stop-at-robot
    :parameters (?dummy - robot ?r - robot ?cat - cell ?cnext - cell ?dir - direction)
    :precondition
        (and
            (is-moving ?r ?dir)
            (at ?r ?cat)
