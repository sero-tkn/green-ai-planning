...
#ifndef __BWD_LANDMARK_COUNT__
#define __BWD_LANDMARK_COUNT__
...
namespace aptk {
    ...
    namespace agnostic {
        ...
        public:
            typedef         aptk::backward::agnostic::Landmarks_Graph_Manager<bwd_Search_Problem,Fwd_Search_Problem>   Landmarks_Graph_Manager_bwd;
            typedef         aptk::backward::agnostic::Landmarks_Graph_Manager<bwd_Search_Problem,Fwd_Search_Problem>   Landmarks_Graph_Manager_fwd;
