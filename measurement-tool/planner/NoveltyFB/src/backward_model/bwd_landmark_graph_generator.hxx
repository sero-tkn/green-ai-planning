...
#ifndef __BWD_LANDMARK_GRAPH_GENERATOR__
#define __BWD_LANDMARK_GRAPH_GENERATOR__

#include <base_search_prob.hxx>
#include <bwd_heuristic.hxx>
#include <bwd_reachability.hxx>
...
public:
	...
	m_collect_lm_in_init_bwd(false), m_collect_lm_in_init_fwd(false),search_prob_bwd(prob_bwd),search_prob_fwd(prob_fwd)
	{
		...
		m_reachability_bwd = new aptk::backward::agnostic::Reachability_Test( prob_bwd.task() );
        m_reachability_fwd = new aptk::backward::agnostic::Reachability_Test( prob_fwd.task() );
	}
